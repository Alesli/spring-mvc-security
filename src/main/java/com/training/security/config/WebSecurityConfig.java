...
public class WebSecurityConfig {
    ...
    @Bean
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity, CustomAuthenticationFailureHandler authFailureHandler) throws Exception {
        return httpSecurity.authorizeRequests(authRequest ->
                        authRequest.antMatchers(HttpMethod.GET, "/about", "/login*", "/blocked").permitAll()
